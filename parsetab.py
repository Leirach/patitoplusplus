...
_lr_productions = [
  ...
  ('estatuto -> asignacion','estatuto',1,'p_estatuto','patitoParser.py',107),
  ('estatuto -> condicion','estatuto',1,'p_estatuto','patitoParser.py',108),
  ('estatuto -> func_void','estatuto',1,'p_estatuto','patitoParser.py',109),
  ...
  ('asignacion -> id ASSIGN megaexp SEMICOLON','asignacion',4,'p_asignacion','patitoParser.py',118),
  ...
  ('print_options -> print_options COMMA printable','print_options',3,'p_print_multi','patitoParser.py',163),
  ('print_options -> printable','print_options',1,'p_print_multi','patitoParser.py',164),
  ('printable -> megaexp','printable',1,'p_printable_exp','patitoParser.py',168),
  ('printable -> CTES','printable',1,'p_printable','patitoParser.py',170),
  ('lee -> QUACKIN OPENPAR read_options CLOSEPAR SEMICOLON','lee',5,'p_lee','patitoParser.py',179),
  ('read_options -> read_options COMMA id','read_options',3,'p_read_options','patitoParser.py',182),
  ('read_options -> id','read_options',1,'p_read_options','patitoParser.py',183),
  ('retorna -> RETORNA OPENPAR megaexp CLOSEPAR SEMICOLON','retorna',5,'p_retorna','patitoParser.py',188),
  ...
  ('id -> ID OPENBRAC exp CLOSEBRAC','id',4,'p_id_dimensions_one','patitoParser.py',285),
  ('id -> ID OPENBRAC exp CLOSEBRAC OPENBRAC exp CLOSEBRAC','id',7,'p_id_dimensions_two','patitoParser.py',290),
  ('vcte -> CTEI','vcte',1,'p_vcte_CTEI','patitoParser.py',295),
  ('vcte -> CTEF','vcte',1,'p_vcte_CTEF','patitoParser.py',302),
  ('vcte -> TRUE','vcte',1,'p_vcte_CTEB','patitoParser.py',309),
  ('vcte -> FALSE','vcte',1,'p_vcte_CTEB','patitoParser.py',310),
  ('vcte -> CTEC','vcte',1,'p_vcte_CTEC','patitoParser.py',317),
  ('boolean_op -> OR','boolean_op',1,'p_boolean_op','patitoParser.py',334),
  ('boolean_op -> AND','boolean_op',1,'p_boolean_op','patitoParser.py',335),
  ('logical_op -> GT','logical_op',1,'p_logical_op','patitoParser.py',340),
  ('logical_op -> GTE','logical_op',1,'p_logical_op','patitoParser.py',341),
  ('logical_op -> LT','logical_op',1,'p_logical_op','patitoParser.py',342),
  ('logical_op -> LTE','logical_op',1,'p_logical_op','patitoParser.py',343),
  ('logical_op -> NEQ','logical_op',1,'p_logical_op','patitoParser.py',344),
  ('logical_op -> EQ','logical_op',1,'p_logical_op','patitoParser.py',345),
  ('sums -> MINUS','sums',1,'p_sums','patitoParser.py',350),
  ('sums -> PLUS','sums',1,'p_sums','patitoParser.py',351),
  ('multdiv -> TIMES','multdiv',1,'p_multdiv','patitoParser.py',356),
  ('multdiv -> DIVIDE','multdiv',1,'p_multdiv','patitoParser.py',357),
  ('unary_ops -> MINUS','unary_ops',1,'p_unary_ops','patitoParser.py',362),
  ('unary_ops -> PLUS','unary_ops',1,'p_unary_ops','patitoParser.py',363),
  ('unary_ops -> DETERM','unary_ops',1,'p_unary_ops','patitoParser.py',364),
  ('unary_ops -> TRANSPOSE','unary_ops',1,'p_unary_ops','patitoParser.py',365),
  ('unary_ops -> INVERSE','unary_ops',1,'p_unary_ops','patitoParser.py',366),
  ('empty -> <empty>','empty',0,'p_empty','patitoParser.py',372),
]
